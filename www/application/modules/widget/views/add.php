...
<?= form_open_multipart(base_url() . 'admin/' . $module . '/add') ?>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input required name='title' value="<?= set_value('title') ?>" type="text" class="form-control" id="title" placeholder="Название">
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            <label for="text">Значение виджета</label>
            <textarea style="width: 100%" rows="10" name="text" id="text"><?= set_value('text') ?></textarea>
            <script>
