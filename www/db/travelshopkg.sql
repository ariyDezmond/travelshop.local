...
--
-- Хост: localhost:3306
-- Время создания: Фев 15 2015 г., 14:24
...
INSERT INTO `allreviews` (`id`, `name`, `text`, `date`, `ip`, `read`, `order`, `active`) VALUES
(13, 'Улан', 'Так волновались впервые вырваться за границу, не знали чего ожидать, что делать, как вообще подступиться к этому вопросу. И столь просто, оказалось, сделать это с компанией «Travel Shop». Мы успели побывать в трех странах, набраться впечатлений, новых знаний и просто отдохнуть. Люба выбрала для нас все, забронировала, объяснила, нам лишь нужно было следовать её указаниям и ни о чем больше не беспокоиться. Не возникало проблем ни с чем, можно полноценно наслаждаться отдыхом. Теперь точно знаем куда обращаться, в случае поездки за границу и не только! Спасибо вам за работу!', '2015-02-13 12:35:17', '212.2.229.47', '0', 0, ''),
(14, 'Улан', 'Так волновались впервые вырваться за границу, не знали чего ожидать, что делать, как вообще подступиться к этому вопросу. И столь просто, оказалось, сделать это с компанией «Travel Shop». Мы успели побывать в трех странах, набраться впечатлений, новых знаний и просто отдохнуть. Люба выбрала для нас все, забронировала, объяснила, нам лишь нужно было следовать её указаниям и ни о чем больше не беспокоиться. Не возникало проблем ни с чем, можно полноценно наслаждаться отдыхом. Теперь точно знаем куда обращаться, в случае поездки за границу и не только! Спасибо вам за работу!', '2015-02-13 12:35:22', '212.2.229.47', '0', 0, 'on');
...
(1, 'выфв', 'выфвф', '2015-02-13 03:27:00', '127.0.0.1', '0'),
(2, 'Meerima', '0 702 777 252', '2015-02-14 17:23:23', '212.112.100.27', '0');
...
(5, 'сеул', 'двухкомнатный', '300$', 'Айткул Саттарова', '+996779113318', 'avazofa@gmail.com', 'мы просто хотим потуществовать!', '2015-02-14 17:51:44', '89.237.196.11', '0', '1', 'двухместный', '7 дней');
...
(3, 'Улан', 'Так волновались впервые вырваться за границу, не знали чего ожидать, что делать, как вообще подступиться к этому вопросу. И столь просто, оказалось, сделать это с компанией «Travel Shop». Мы успели побывать в трех странах, набраться впечатлений, новых знаний и просто отдохнуть. Люба выбрала для нас все, забронировала, объяснила, нам лишь нужно было следовать её указаниям и ни о чем больше не беспокоиться. Не возникало проблем ни с чем, можно полноценно наслаждаться отдыхом. Теперь точно знаем куда обращаться, в случае поездки за границу и не только! Спасибо вам за работу!', '', '2015-02-11 04:22:16', '127.0.0.1', 'on', 'on', 11),
...
(11, 'Spice Hotel & Spa', 'spice_hotel__spa', 'Турция, Анталия, Белек', '12 450 руб', '330246fb040db1d0ac9a2adfd7bac060.jpg', '2015-01-07 06:00:00', '7', '2015-01-07 06:00:00', 19, '-', '-', 'Ультра все включено', '-', 'Пегасус Азия, Турецкие авиалинии', 'Пегасус Азия, Турецкие авиалинии', 'Страховка, перелет, трансфер, отель', 'new', 'Бишкека', 'Индивидуальный расчет', 0, 'on', '0', 'spice_hotel__spa', 'Туры в турцию', 'туры в турцию', 'туры в турцию'),
(12, 'Alila Diwa Goa', 'alila_diwa_goa', 'Индия, Гоа', '-', 'bf8cb3af97890ca33b37ac33a04af187.jpg', '1970-01-01 06:00:00', '-', '2015-01-08 06:00:00', 20, '-', '-', '-', '-', 'Айр Астана, Чартер', 'Айр Астана, Чартер', '-', 'action', 'Алматы', '-', 0, 'on', '0', 'Индия, Гоа', 'Индия, Гоа', 'Индия, Гоа', 'Индия, Гоа'),
...
(45, 'belay-title', 'Медицинская страховка \n\n', 8),
...
--
-- Indexes for table `allreviews`
--
ALTER TABLE `allreviews`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `allreviews`
--
ALTER TABLE `allreviews`
...
--
-- AUTO_INCREMENT for table `vises`
--
ALTER TABLE `vises`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
